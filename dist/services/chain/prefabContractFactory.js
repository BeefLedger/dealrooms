...
export function getErc20Contract(address, signerIdxOrAddressOrSigner) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, getContract(address, Erc20DetailedCompiled.abi, signerIdxOrAddressOrSigner)];
        });
    });
}
export function getErc721Contract(address, signerIdxOrAddressOrSigner) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, getContract(address, Erc721DetailedCompiled.abi, signerIdxOrAddressOrSigner)];
        });
    });
}
export function getMultiSigContract(address, signerIdxOrAddressOrSigner) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, getContract(address, MultiSigHashedCompiled.abi, signerIdxOrAddressOrSigner)];
        });
    });
}
